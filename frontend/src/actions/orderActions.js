...
export const allVendorOrders = (products) => async (dispatch) => {
  try {
    dispatch({ type: ALL_ORDERS_REQUEST });

    const { data } = await axios.post(`/api/v1/vendor/orders`, {
      products,
    });
...
// // export const vAllOrders = () => async (dispatch) => {
// //   try {
// //     dispatch({ type: ALL_ORDERS_REQUEST });
